	...
	function clear_data_22() {
        if (tooth_22 == 1) {
			...
			pd_22_mb = 0;
				...
				document.getElementById('gm_22_db_txt').value = 0;
				document.getElementById('gm_22_b_txt').value = 0;
				document.getElementById('gm_22_mb_txt').value = 0;
				
				document.getElementById('pd_22_db_txt').value = 0;
				document.getElementById('pd_22_b_txt').value = 0;
				document.getElementById('pd_22_mb_txt').value = 0;
			
				document.forms[0]["pd_22_db"].style.color = 'black'
				document.forms[0]["pd_22_b"].style.color = 'black'
				document.forms[0]["pd_22_mb"].style.color = 'black'
			...
			pd_22_mp = 0;
				...
				document.getElementById('gm_22_dp_txt').value = 0;
				document.getElementById('gm_22_p_txt').value = 0;
				document.getElementById('gm_22_mp_txt').value = 0;
				
				document.getElementById('pd_22_dp_txt').value = 0;
				document.getElementById('pd_22_p_txt').value = 0;
				document.getElementById('pd_22_mp_txt').value = 0;

				document.forms[0]["pd_22_dp"].style.color = 'black'
				document.forms[0]["pd_22_p"].style.color = 'black'
				document.forms[0]["pd_22_mp"].style.color = 'black'
			
			change_probing_22();
			
			mobility_22 = 0;

				document.getElementById('mobility_22_txt').value = "0";

			note_22 = "";

				document.getElementById('note_22_txt').value = "";
	...
	function toggle_tooth_22() {
		if (tooth_22 === 1) {
			...
			document.getElementById('mobility_22_txt').style.display = 'none';
			...
			document.getElementById('gm_22_db_txt').style.display = 'none';
			document.getElementById('gm_22_b_txt').style.display = 'none';
			document.getElementById('gm_22_mb_txt').style.display = 'none';
			
			document.getElementById('pd_22_db_txt').style.display = 'none';
			document.getElementById('pd_22_b_txt').style.display = 'none';
			document.getElementById('pd_22_mb_txt').style.display = 'none';
			
			document.getElementById('gm_22_dp_txt').style.display = 'none';
			document.getElementById('gm_22_p_txt').style.display = 'none';
			document.getElementById('gm_22_mp_txt').style.display = 'none';
			
			document.getElementById('pd_22_dp_txt').style.display = 'none';
			document.getElementById('pd_22_p_txt').style.display = 'none';
			document.getElementById('pd_22_mp_txt').style.display = 'none';
			...
			document.getElementById('polyline_al_22_b').style.display = 'none';
			document.getElementById('polyline_gm_22_b').style.display = 'none';
			
			document.getElementById('polygon_22_p').style.display = 'none';
			document.getElementById('polyline_al_22_p').style.display = 'none';
			document.getElementById('polyline_gm_22_p').style.display = 'none';
			...
			document.getElementById('note_22_txt').style.display = 'none';
		}
			...
			document.getElementById('mobility_22_txt').style.display = 'block';

			document.getElementById('implantat_22_btn').style.display = 'block';

			document.getElementById('gm_22_db_txt').style.display = 'block';
			document.getElementById('gm_22_b_txt').style.display = 'block';
			document.getElementById('gm_22_mb_txt').style.display = 'block';
			
			document.getElementById('pd_22_db_txt').style.display = 'block';
			document.getElementById('pd_22_b_txt').style.display = 'block';
			document.getElementById('pd_22_mb_txt').style.display = 'block';
			
			document.getElementById('gm_22_dp_txt').style.display = 'block';
			document.getElementById('gm_22_p_txt').style.display = 'block';
			document.getElementById('gm_22_mp_txt').style.display = 'block';
			
			document.getElementById('pd_22_dp_txt').style.display = 'block';
			document.getElementById('pd_22_p_txt').style.display = 'block';
			document.getElementById('pd_22_mp_txt').style.display = 'block';
			
			document.getElementById('note_22_txt').style.display = 'block';

			document.getElementById('polygon_22_b').style.display = 'block';
			document.getElementById('polyline_al_22_b').style.display = 'block';
			document.getElementById('polyline_gm_22_b').style.display = 'block';
			
			document.getElementById('polygon_22_p').style.display = 'block';
			document.getElementById('polyline_al_22_p').style.display = 'block';
			document.getElementById('polyline_gm_22_p').style.display = 'block';
	...
	function change_probing_22() {
		...
		// Variablen aus dem Formular
			...
			pd_22_b = document.forms[0]["pd_22_b"].value;
			pd_22_mb = document.forms[0]["pd_22_mb"].value;

			if (document.forms[0]["pd_22_dp"].value > 3) {document.forms[0]["pd_22_dp"].style.color = 'red';} else {document.forms[0]["pd_22_dp"].style.color = 'black'};
			if (document.forms[0]["pd_22_p"].value > 3) {document.forms[0]["pd_22_p"].style.color = 'red';} else {document.forms[0]["pd_22_p"].style.color = 'black'};
			if (document.forms[0]["pd_22_mp"].value > 3) {document.forms[0]["pd_22_mp"].style.color = 'red';} else {document.forms[0]["pd_22_mp"].style.color = 'black'};
			
			gm_22_db = document.forms[0]["gm_22_db"].value;
			gm_22_b = document.forms[0]["gm_22_b"].value;
			gm_22_mb = document.forms[0]["gm_22_mb"].value;
			
			pd_22_dp = document.forms[0]["pd_22_dp"].value;
			pd_22_p = document.forms[0]["pd_22_p"].value;
			pd_22_mp = document.forms[0]["pd_22_mp"].value;

			if (document.forms[0]["pd_22_db"].value > 3) {document.forms[0]["pd_22_db"].style.color = 'red';} else {document.forms[0]["pd_22_db"].style.color = 'black'};
			if (document.forms[0]["pd_22_b"].value > 3) {document.forms[0]["pd_22_b"].style.color = 'red';} else {document.forms[0]["pd_22_b"].style.color = 'black'};
			if (document.forms[0]["pd_22_mb"].value > 3) {document.forms[0]["pd_22_mb"].style.color = 'red';} else {document.forms[0]["pd_22_mb"].style.color = 'black'};
			
			gm_22_dp = document.forms[0]["gm_22_dp"].value;
			gm_22_p = document.forms[0]["gm_22_p"].value;
		...
		// Attachmentniveau 22 bukkal zeichnen
			var string = 
				...
				x_b_22 + ", " + y_al_22_b + "  " + 
				x_mb_22 + ", " + y_al_22_mb;
			document.getElementById("polyline_al_22_b").setAttribute("points", string);
		// Margo Gingivae 22 bukkal zeichnen
			var string =
				x_db_22 + ", " + y_gm_22_db + "  " + 
				x_b_22 + ", " + y_gm_22_b + "  " + 
				x_mb_22 + ", " + y_gm_22_mb;
			document.getElementById("polyline_gm_22_b").setAttribute("points", string);
		...
		// Attachmentniveau 22 palatinal zeichnen
			var string = 
				...
				x_p_22 + ", " + y_al_22_p + "  " + 
				x_mp_22 + ", " + y_al_22_mp;
			document.getElementById("polyline_al_22_p").setAttribute("points", string);
		// Margo Gingivae 22 palatinal zeichnen
			var string =
				x_dp_22 + ", " + y_gm_22_dp + "  " + 
				x_p_22 + ", " + y_gm_22_p + "  " + 
				x_mp_22 + ", " + y_gm_22_mp;
			document.getElementById("polyline_gm_22_p").setAttribute("points", string);
		}
        if (tooth_22 == 1 && tooth_21 == 1) {
